...
from rag import build_embeddings, build_llm, get_vectorstore, PROMPT, REWRITE_PROMPT
...
def build_agent_graph():
    """질문엔 answer_question, 오늘 회고형 발화엔 til_write, 주간/메타인지 회고 요청엔 wil_synthesize·retrospective_write를 LLM이 스스로 골라 호출하는 대화형 에이전트."""
